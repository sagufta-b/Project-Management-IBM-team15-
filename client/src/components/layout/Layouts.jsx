                ...
                <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
                    ...
                    {user?.role === 'admin' && (
                        <div className="mt-8">
                            ...
                            <Link
                                to="/admin/users"
                                className={`flex items-center gap-3 py-2.5 px-4 rounded-lg transition-colors ${location.pathname === '/admin/users'
                                    ? 'bg-indigo-600 text-white'
                                    : 'text-slate-400 hover:bg-slate-800 hover:text-white'
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                className={`flex items-center gap-3 py-2.5 px-4 rounded-lg transition-colors ${location.pathname === '/admin/create-user'
                                    ? 'bg-indigo-600 text-white'
                                    : 'text-slate-400 hover:bg-slate-800 hover:text-white'
                                    }`}
                            >
